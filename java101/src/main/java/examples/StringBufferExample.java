...
public class StringBufferExample {
    public static void main(String[] args) {
        ...
        // it reserve empty content and 16 characters
        ...
        StringBuffer stringBufferHelloWorld = new StringBuffer("Hello World");
        System.out.println("capacity " +  stringBufferHelloWorld.capacity());

        // length
        System.out.println("length " +  stringBufferHelloWorld.length());
