...
public class ConcurrencyDeadLockRunnable1 implements Runnable {

    private Lock lock1 = null;
    private Lock lock2 = null;

    public ConcurrencyDeadLockRunnable1(Lock lock1, Lock lock2){
        this.lock1 = lock1;
        this.lock2 = lock2;
    }
    ...
    public void run() {
        ...
        System.out.println(threadName + " lock2 will lock here");
        lock2.lock();
        ...
        System.out.println(threadName + " lock1 will lock");
        lock1.lock();
